  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast.success('Logged in successfully!', {
        description: 'Welcome back to FreshPress.',
        duration: 5000,
      });
      setIsLoading(false);
    }, 1500);
    ...
    <div className="w-full max-w-md mx-auto p-6 space-y-8 animate-fadeIn">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">
          Sign in to your FreshPress account
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm text-laundry-600 hover:text-laundry-800 dark:text-laundry-400 dark:hover:text-laundry-300">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
      ...
      <p className="text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <Link to="/signup" className="font-medium text-laundry-600 hover:text-laundry-500 dark:text-laundry-400 dark:hover:text-laundry-300">
          Sign up
        </Link>
      </p>
    </div>
